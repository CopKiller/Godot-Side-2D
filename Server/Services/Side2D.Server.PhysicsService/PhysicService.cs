...
public class PhysicService(ICombatService combatService) : IPhysicService
{
    ...
    public void Start()
    {
        ...
        var physicWorld = new PhysicWorld(1, NetworkEvents, new Vector2(0, 9.8f));
        
        Worlds.Add(1, physicWorld);
        
        var body = BodyFactory.CreateEdge(physicWorld, new Vector2(0, 1000), new Vector2(1500, 1000));
    ...
    public void AddWorldPhysic(int index, Vector2 gravity, List<CustomVertices> vertices, int density)
    {
        ...
        Worlds.Add(index, new PhysicWorld(index, NetworkEvents, gravity, verticesList, density));
    }

    public void AddWorldPhysic(int worldIndex, Vector2 gravity)
    {
        var world = new PhysicWorld(worldIndex, NetworkEvents, gravity);
    ...
    public void AddPhysicEntity(int worldIndex, int entityIndex, EntityType type, Vector2 position)
    {
        switch (type)
        {
            ...
            {
                var result = Worlds[worldIndex].AddPhysicEntity(entityIndex, type, position);
