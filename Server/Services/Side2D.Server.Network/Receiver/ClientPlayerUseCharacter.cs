...
public partial class ServerPacketProcessor
{
    public void ClientPlayerUseCharacter(CPlayerUseCharacter obj, NetPeer netPeer)
    {
        ...
        if (player.TempPlayer.UpdatePlayerVar != null)
            player.TempPlayer.UpdatePlayerVar.SendVitals = (vitals) => ServerUpdateVitals(player.Index, vitals);
        
        // Envia uma atualização de vitals, pra carregar na game bars
        ServerUpdateVitals(player.Index, player.PlayerDataModel.Vitals);
    }
}