...
public partial class VirtualJoystick : Control
{
    ...
    [Export] public string ActionLeft = "move_left";
    [Export] public string ActionRight = "move_right";
    [Export] public string ActionUp = "move_jump";
    [Export] public string ActionDown = "move_down";
    ...
    private bool IsJoyStickVisible()
    {
        return EnvironmentSettings.CurrentPlatform is EnvironmentPlatforms.Android or EnvironmentPlatforms.iOS;
    }
}